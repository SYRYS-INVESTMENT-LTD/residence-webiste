  ...
  return (
    <div className="relative p-4 h-[28rem]">
      <div className="relative cursor-pointer">
        ...
        <div className="absolute bottom-10 left-0 w-full h-auto px-4 py-3 text-white rounded-b-lg">
        ...
        <div className="absolute bottom-16 font-generalsans right-2 bg-white text-[#199976] px-2 py-1 rounded-3xl">
          For Rent
        </div>
      </div>
    </div>
