...
function HeroSection() {
  return (
    <div className="items-center justify-center text-center mt-16">
      <h1 className="font-aeonikmedium md:text-4xl text-base text-[#262626]">
      ...
      <div>
        {window.innerWidth < 700 ? (
          <>
            <div className="md:mx-60 mx-4 font-aeonik text-sm scale-95 md:text-sm mt-6 text-[#5A5A5A]">
              <p>
          ...
          <>
            <div className="md:mx-60 mx-4 font-aeonik text-2xl scale-95 md:text-sm mt-6 text-[#5A5A5A]">
              <p>
                Experience guaranteed returns and a quality lifestyle with
