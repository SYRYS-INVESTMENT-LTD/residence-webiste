...
function BookingModal() {
  ...
  return (
    <div>
      ...
      {showModal && (
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-10 p-4 sm:p-10">
              ...
              <div>
                ...
                {selectedDate && (
                  <div className="mt-6">
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-2 md:grid-cols-6 font-aeonikmedium">
