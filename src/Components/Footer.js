  ...
  return (
    <div className='bg-[#0A0A0A] py-14 px-4 md:p-14 md:flex justify-between items-start md:space-y-0 space-y-10'>
      <div>
        ...
        <p className='font-aeonik text-sm mt-4 text-white'>Experience hassle-free property management </p>
        <p className='font-aeonik text-sm text-white'>like never before</p>
      </div>

      <div>
        <h1 className='text-xs font-aeonik text-white'>CONTACT</h1>
        <div className='flex items-center space-x-3 mt-4'>
        <MdMail color='#fff' size={26}/>
          <h1 className='font-aeonik text-white '>support@syrysapp.com</h1>
        </div>
        <div className='flex items-center space-x-3 mt-4'>
          <img src={Linkedin} alt='Linkedin' className='h-6'/>
          <h1 className='font-aeonik text-white '>Linkedin</h1>
        </div>
        <div className='flex items-center space-x-3 mt-4'>
        <img src={Facebook} alt='Facebook' className='h-6'/>
          <h1 className='font-aeonik text-white'>Facebook</h1>
        </div>
        <div className='flex items-center space-x-3 mt-4'>
        <img src={Instagram} alt='Instagram' className='h-6'/>
          <h1 className='font-aeonik text-white '>Instagram</h1>
        </div>
      </div>
